...
@Login5 
Cenário: Efetuar login da tela de cadastro
Dado que estou na tela inicial do aplicativo
E clicar em cadastrar
Quando cadastrar os dados de usuário com CPF já cadastrado
E eu clicar no botão de ir para o login
E informar os dados de usuário válidos
Então devo acessar a home logado com sucesso
...
Dado que estou na tela inicial do aplicativo com uma versão bloqueada
E clicar em entrar
Quando informar os dados de usuário válidos
...
Dado que estou na tela inicial do aplicativo com uma versão desatualizada
E clicar em entrar
Quando informar os dados de usuário válidos
